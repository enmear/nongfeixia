// pages/dealerindex/dealerindex.js
var app = getApp();
...
Page({
  ...
  data: {
    ...
    tabbar: [
      ...
      {
        text: "发布推文",
        iconPath: "../../images/tweet.png",
        selectedIconPath: "../../images/tweet_on.png",
        selected: false
      }
    ],
 ...
 */
  ...
  */
  ...
  onLoad: function (options) {
    ...
    app.globalData.currentIdentify = '经销商'
